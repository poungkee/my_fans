...
const AgencySection = ({ selectedAgency, onAgencySelect }) => {
  ...
  const fallbackAgencies = {
    '종합일간지': ['연합뉴스', '조선일보', '중앙일보', '동아일보', '한겨레', '경향신문'],
    '방송사': ['KBS', 'MBC', 'SBS', 'YTN', 'JTBC', '채널A'],
    '경제전문': ['한국경제', '매일경제', '서울경제', '헤럴드경제', '아시아경제'],
    'IT/과학': ['전자신문', 'ZDNet Korea', '디지털타임스', '블로터', 'AI타임스'],
    '스포츠': ['스포츠조선', '스포츠서울', '일간스포츠', 'OSEN', '엑스포츠뉴스'],
    '지역언론': ['부산일보', '영남일보', '광주일보', '강원일보', '제주일보']
  };
